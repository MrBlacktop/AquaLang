...
class ExerciseAdapter(activity: AppCompatActivity, private val exercises: List<Exercise>) :
    ...
    override fun createFragment(position: Int): Fragment {
        return when (exercises[position].type) {
            ...
            ExerciseType.MULTIPLE_OPTIONS -> MultipleOptionExerciseFragment.newInstance(position)
            ExerciseType.TEXT_INPUT -> TextInputExerciseFragment.newInstance(position)
        }
    }
